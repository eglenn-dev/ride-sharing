      ...
      <section className="island-shell rise-in mx-auto max-w-md rounded-2xl p-6 sm:p-8">
        ...
        <form onSubmit={handleSubmit} className="grid gap-4">
          <div className="grid gap-2">
            <label
              htmlFor="email"
              className="text-sm font-medium leading-none text-[var(--sea-ink)]"
            >
              Email
            </label>
            <input
          ...
          <button
            type="submit"
            disabled={loading}
            className="h-9 w-full rounded-full border border-[rgba(50,143,151,0.3)] bg-[rgba(79,184,178,0.14)] px-5 text-sm font-semibold text-[var(--lagoon-deep)] transition hover:bg-[rgba(79,184,178,0.24)] disabled:cursor-not-allowed disabled:opacity-50"
          >
            {loading ? (
