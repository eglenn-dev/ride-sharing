      ...
      <section className="hero-commuter hero-full-bleed rise-in relative overflow-hidden">
        ...
        <div className="page-wrap px-6 py-5 sm:px-10 sm:py-8">
          ...
          <p className="mb-8 max-w-2xl text-base text-[var(--sea-ink-soft)] sm:text-lg">
            Connect with riders and drivers in your community. Save money,
            reduce your carbon footprint, and make every commute count.
          </p>
          <div className="flex flex-wrap gap-3">
            {session?.user && (
              <>
                <Link to="/rides/search" className="hero-cta hero-cta-primary">
                  Find Rides
                </Link>
            ...
            {!session?.user && (
              <>
                <Link to="/auth/signup" className="hero-cta hero-cta-primary">
                  Get Started
                </Link>
                <Link to="/auth/login" className="hero-cta hero-cta-secondary">
                  Log In
                </Link>
              </>
            )}
