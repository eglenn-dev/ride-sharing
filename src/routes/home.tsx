                ...
                {bookings.length === 0 ? (
                    ...
                    <div className="grid justify-items-start gap-4 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4">
                        {sortedBookings.map((booking) => {
                            ...
                            const maxEditableSeats =
                                booking.seatsBooked + booking.ride.availableSeats
                            const isEditing = editingBookingId === booking.id

                            return (
                                <article
                                    key={booking.id}
                                    className="island-shell feature-card rise-in w-full max-w-sm rounded-2xl p-4"
                                >
                                    ...
                                    {isEditing ? (
                                        <>
                                            <button
                                                type="button"
                                                onClick={() => {
                                                    void handleSaveBooking(booking.id)
                                                }}
                                                disabled={savingBookingId === booking.id}
